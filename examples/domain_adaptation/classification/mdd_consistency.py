...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    for i in range(args.iters_per_epoch):
        ...
        consis_loss = consistency_loss(y_t, y_t_strong, T=1.0, p_cutoff=args.thr)

        loss = cls_loss + transfer_loss * args.trade_off + consis_loss * args.trade_off_consistency
        classifier.step()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--thr', default=0.95, type=float, help='parameter temperature scaling')
    # training parameters
